...
#    first_name = forms.CharField(label="Nom", max_length=200, help_text='', required=True, min_length=5, widget=forms.TextInput(attrs={"class":"form-control", "id":"nom", "type":"text", "placeholder":"Nom", "data-sb-validations":"required" }))
#    last_name = forms.CharField(label="Prénom", max_length=200, help_text='', required=True, min_length=5, widget=forms.TextInput(attrs={"class":"form-control", "id":"prenom", "type":"text", "placeholder":"Prenom", "data-sb-validations":"required" }))
